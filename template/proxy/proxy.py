from template.proxy.modules import PROXY_REGISTRY
from template.proxy.modules.pm_proxy import get_polymarket_eod, get_kalshi_candles_eod
from template.const import Task, Option, FINANCIAL_CATEGORIES, PREDMARKET_CATEGORIES, BASIC_PROXIES, BASE_COMMISSION, RETURN_BOUND, Proposition
import inspect
import argparse
